...
const IPadHero = () => {
	return (
		<Grid
			component='section'
			className='section-iPad-hero-product'
			sx={{
				width: '100%',
				p: { mobile: '0 0 85px 0', tablet: '0 0 88px 0', laptop: '0 0 35px 0' },
				overflow: 'hidden',
				backgroundColor: '#fff'
			}}>
			<Box
				...
				<Box
					...
					<Box
						...
						<Box
							className='iPad_hero-image'
							component='figure'
							sx={{
								position: 'relative',
								left: '50%',
								margin: { mobile: '0 0 0 -236.5px', tablet: '0 0 0 -323.5px', laptop: '0 0 0 -540.5px' },
								width: { mobile: '415px', tablet: '663px', laptop: '895px' },
								height: { mobile: '220px', tablet: '350px', laptop: '473px' },
								backgroundImage: {
									mobile: 'url(./hero/ipad_102_small_2x.jpg)',
									tablet: 'url(./hero/ipad_102_medium_2x.jpg)',
									laptop: 'url(./hero/ipad_102_large_2x.jpg)'
								},
					...
					<Box
						...
						<Typography
							variant='eyebrow'
							component='p'
							sx={{ mt: '6px', textAlign: { mobile: 'center', tablet: 'left', minWidth: '320px' } }}>
							Delightfully capable.
							<br /> Surprisingly affordable.
						</Typography>
